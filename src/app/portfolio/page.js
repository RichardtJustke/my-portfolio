import AboutSection from "@/components/AboutSection"; // <-- importa a seção
  ...
  return (
    <main className="min-h-screen bg-black text-white flex flex-col items-center px-6">
      ...
      <section className="mt-16 grid gap-6 md:grid-cols-4 text-center max-w-6xl w-full">
        <a href="/portfolio/identidade-visual" className="rounded-xl bg-white/5 px-6 py-10 hover:bg-white/10 transition">
          <h2 className="text-lg font-semibold">Identidade Visual</h2>
        </a>
        <a href="/portfolio/web-design" className="rounded-xl bg-white/5 px-6 py-10 hover:bg-white/10 transition">
          <h2 className="text-lg font-semibold">Web Design</h2>
        </a>
        <a href="/portfolio/social-media" className="rounded-xl bg-white/5 px-6 py-10 hover:bg-white/10 transition">
          <h2 className="text-lg font-semibold">Social Media</h2>
        </a>
        <a href="/portfolio/programacao" className="rounded-xl bg-white/5 px-6 py-10 hover:bg-white/10 transition">
