...
func Work(c *fiber.Ctx) error {
	data := WorkData{
		...
		Stack: []StackItem{
			...
			{Name: "Go", Icon: "go/go-original-wordmark.svg", HoverIcon: "/assets/party-gopher.gif"},
			...
			{Name: "Photoshop", Icon: "photoshop/photoshop-original.svg"},
			{Name: "Illustrator", Icon: "illustrator/illustrator-original.svg"},
			{Name: "PostgreSQL", Icon: "postgresql/postgresql-original.svg"},
			{Name: "Claude Code", Icon: "https://raw.githubusercontent.com/lobehub/lobe-icons/refs/heads/master/packages/static-png/light/claudecode-color.png", IsURL: true},
		},
		Experiences: []Experience{
			{
				Company: "EasyPlan",
				Role:    "Software Developer",
				Desc:    "I am directly involved in the development of systems used by EasyPlan's clients and internal teams. My work involves web, mobile, and backend applications, working with React, TypeScript, Go, and Docker. I contributed to the evolution of the company's sales system, published applications on the App Store and Google Play, and currently develop new API solutions aimed at process automation, system integration, and platform scalability.",
				Period:  "2026 — present",
				Tag:     "current",
			},
			{
		...
		Projects: []Project{
			...
			},
			{
				ID:        "ketsu",
				Name:      "Ketsu",
				Desc:      "Official website for Ketsu.",
				Status:    "live",
				Tags:      []string{"Web"},
				Label:     "KETSU",
				About:     "The official landing page for Ketsu, my design and development startup.",
				Challenge: "Delivering a clean, modern digital presence to attract new clients and showcase our expertise.",
				Tech:      []string{"Web Design", "Development"},
				Link:      "https://ketsu.dev",
				Image:     "/assets/ketsu.png",
			},
		},
	}
